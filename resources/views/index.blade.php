...
<div class="modal fade" id="addEmployeModal" tabindex="-1" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-content">
      ...
      <form action="#" method="POST" id="add_employe_form" enctype="multipart/form-data">
        ...
        <div class="modal-footer">
          ...
          <button type="submit" id="add_employe_btn" class="btn btn-primary">Add Employee</button>
        </div>
      </form>
    </div>
  </div>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <form action="#" method="POST" id="edit_employe_form" enctype="multipart/form-data">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
          <button type="submit" id="edit_employe_btn" class="btn btn-success">Update Employee</button>
        </div>
      </form>
    </div>
  </div>
      ...
      <div class="col-lg-12">
        <div class="card shadow">
          <div class="card-header bg-danger d-flex justify-content-between align-items-center">
            ...
            <button class="btn btn-light" data-bs-toggle="modal" data-bs-target="#addEmployeModal"><i
      ...
      $("#add_employe_form").submit(function(e) {
        ...
        $.ajax({
          ...
          success: function(response) {
            ...
            $("#add_employe_btn").text('Add Employee');
      ...
      $("#edit_employe_form").submit(function(e) {
        ...
        $.ajax({
          ...
          success: function(response) {
            ...
            $("#edit_employe_btn").text('Update Employee');
